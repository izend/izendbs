...
/**
 *
 * @copyright  2010-2022 (2016) izend.org
 * @version    12 (1)
...
function nodecomment($lang, $node_id, $node_user_id, $node_url, $nomore) {
	...
	$output = view('nodecomment', $lang, compact('token', 'action', 'with_mail', 'with_captcha', 'comments', 'moderated', 'id', 'newcomment', 'message', 'message_maxlen', 'mail', 'user_page', 'node_url', 'errors'));
