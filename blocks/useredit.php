...
/**
 *
 * @copyright  2011-2022 (2016-2019) izend.org
 * @version    18 (2)
...
function useredit($lang, $user_id) {
	...
	$errors = compact('missing_name', 'bad_name', 'duplicated_name', 'missing_mail', 'bad_mail', 'duplicated_mail', 'bad_timezone', 'bad_website', 'bad_role', 'missing_locale', 'bad_locale', 'missing_newpassword', 'bad_newpassword', 'missing_oldpassword', 'bad_oldpassword', 'missing_lastname', 'missing_firstname', 'internal_error', 'contact_page');
